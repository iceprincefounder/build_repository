...
export USD_INSTALL="/home/xukai/Git/git_repo/usd/lca_usd_house/usd_centos_v081"
...
if [ ! -d /home/xukai/Git/build_repo/usd_v081 ]; then
      mkdir /home/xukai/Git/build_repo/usd_v081
fi

cd ${USD_REPO}
git checkout v0.8.1

cd "/home/xukai/Git/build_repo/usd_v081"
cmake ${USD_REPO} \
      -G "Unix Makefiles" \
